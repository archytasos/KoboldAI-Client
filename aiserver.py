...
class vars:
    ...
    lazy_load   = False # need for 8 bit # Whether or not to use torch_lazy_loader.py for transformers models in order to reduce CPU memory usage
...
def reset_model_settings():
    ...
    vars.newlinemode = "n"
    vars.revision    = None
    vars.lazy_load = False # Also needed for 8 bit
